...
const Header = () => {
  ...
  return (
    <header
      className={`header absolute w-full dark:bg-darkmode top-0 z-10 ${isMenuOpen ? "menu-open" : ""} ${
      ...
      <div className="container">
        <div className="flex items-center justify-between py-4">
          ...
          <Link href="/" className="sm:w-[10rem] w-[7.5rem] block">
            <Image
              src={isDark ? " /icon/logo-white.svg " : "/icon/logo.svg"} 
              alt="logo"
              width={0}
              height={0}
              layout="responsive"
          ...
          <div className="flex items-center gap-4">
            <Link href="#" className="btn sm:px-[1.325rem] px-[0.5rem]">
              Buy Now
            </Link>
            <span
              id="mobiletoggle"
